...
/**
 ...
 3. CREATE TABLE must create a new file, respecting the SQL syntax for creating the fields. For example:
 ...
 4. DROP TABLE should remove the file from the folder. **Ask if you really want to delete the file**.
 5. INSERT should insert a new line in the file/table. respecting the SQL syntax. For example:
